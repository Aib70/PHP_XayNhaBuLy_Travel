...
<?php 
    ...
    $menu = [
        'vi' => ['home' => 'Trang chủ', 'places' => 'Địa danh', 'festivals' => 'Các lễ hội', 'about' => 'Về chúng tôi', 'logout' => 'Đăng xuất'],
        'lo' => ['home' => 'ໜ້າຫຼັກ', 'places' => 'ສະຖານທີ່', 'festivals' => 'ບຸນປະເພນີ', 'about' => 'ກ່ຽວກັບພວກເຮົາ', 'logout' => 'ອອກຈາກລະບົບ'],
        'en' => ['home' => 'Home', 'places' => 'Places', 'festivals' => 'Festivals', 'about' => 'About Us', 'logout' => 'Logout']
    ];
    $text = $menu[$lang];
...
<nav class="navbar">
    ...
    <div class="nav-container">
        <ul class="nav-links">
            ...
            <li>
    <a href="<?php echo URLROOT; ?>/place/all" class="<?php echo (strpos($_SERVER['REQUEST_URI'], '/place/all') !== false) ? 'active-link' : ''; ?>">
        <?php echo $text['places']; ?>
    </a>
</li>
<li>
    <a href="<?php echo URLROOT; ?>/place/category/2" class="<?php echo ($current_cat == 2) ? 'active-link' : ''; ?>">
        <?php echo ($lang == 'vi') ? 'Khách sạn' : (($lang == 'lo') ? 'ໂຮງແຮມ' : 'Hotels'); ?>
    </a>
</li>           

            <li>
                <a href="<?php echo URLROOT; ?>/place/category/5" class="<?php echo ($current_cat == 5) ? 'active-link' : ''; ?>">
